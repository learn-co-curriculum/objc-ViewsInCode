...
- (void)viewDidLoad
{
    ...
    segmentedControl.frame = CGRectMake(segmentedControl.frame.origin.x, segmentedControl.frame.origin.y, 150, segmentedControl.frame.size.height);

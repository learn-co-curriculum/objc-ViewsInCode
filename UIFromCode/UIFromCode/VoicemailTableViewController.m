...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        self.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Voicemail" image:voicemailThin selectedImage:voicemailThick];
    }
    return self;
}
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Greeting" style:UIBarButtonItemStylePlain target:self action:@selector(greetingPressed)];
